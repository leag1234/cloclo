...
the gateway's existing conservative context bound; then the M10 deterministic
hierarchy examines the whole source. The gateway retains0.10 EUR/120s and its shared
