#!/usr/bin/env bash
# verify-m4 — PROTÉGÉ (CODEOWNERS). Gabarit fail-closed : échoue tant que le
...
fail(){ echo "::error::verify-m4: $*"; exit 1; }
pass(){ echo "  ✓ $*"; }
echo "== verify-m4 =="
# Critères (source: MISSION.md) :
#   - POC-E8 >= 85%
#   - zéro sous-routage sur cas critiques
#   - panne GPU simulée -> fallback répond
MARKER="BRAIN/m4.done"
